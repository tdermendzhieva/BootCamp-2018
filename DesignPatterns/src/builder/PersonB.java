...
public class PersonB {
	...
	public PersonB createPersonForTesting() {
		return PersonB.builder().firstName("FirstName").lastName("LastName").addressOne("AddressOne")
				.addressTwo("AddressTwo").birthDate(LocalDate.of(1995, Month.APRIL, 13)).sex("male").driverLicence(true)
				.married(true).build();
	}
